...
export function HomeHero() {
  return (
    <section>
      <Container>
        <div className="text-center lg:text-left h-auto lg:h-[calc(100vh-10rem)] py-24 w-full grid grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 gap-16">
          ...
          <motion.div
            ...
            className="flex-1 relative w-full h-64 lg:h-full"
          >
            <HomeHeroImageSlider />
          </motion.div>
        </div>
